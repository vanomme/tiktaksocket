...
export function updateBoard(board: (string | null)[]) {
...
export function updateTurn(turn: string, name: string) {
...
export function showCoinResult(winnerName: string, message: string) {
    elements.coinAnimation.innerHTML = `
...
export function updatePlayerList(players: any[], myPlayerId: string, onChallenge: (id: string) => void, onSpectate: (id: string) => void) {
...
export function showChallengeModal(username: string, onAccept: () => void, onDecline: () => void) {
...
export function showNotification(title: string, message: string, onClose?: () => void) {
